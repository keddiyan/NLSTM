...
def load_data_old():
    ...
    true_fault_data_test = dataSet_test[500:600, 1:]
    true_fault_label_test = dataSet_test[500:600, 0]
    #归一化
    ...
    test_label1 = test_label1.reshape(100,1)
...
def Lstm_models():
    ...
    model = Sequential()
    model.add(LSTM(units = 64,input_shape=(num1,65),return_sequences=True,activation='relu'))
